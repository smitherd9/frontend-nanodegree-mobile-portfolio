...
var resizePizzas = function(size) {
  ...
  // Optimized by moving variables outside of for loop
...
//Optimization: Stored phase values in array
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    //the list of pizzas is
    //Can we just store 5 numbers and use those numbers to change the positions of our elements?
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
// Optimization: Make number of pizzas generated based on window height
